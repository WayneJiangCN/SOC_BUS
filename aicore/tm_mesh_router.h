...
class TmMeshRouter : public tm_engine::TmModule
{
  public:
    ...
    void attach(uint32_t router_id,
                ...
                p_tm_mesh_link_t east_link, p_tm_mesh_link_t west_link,
  ...
  private:
    ...
    p_tm_mesh_link_t output_link(TmMeshPortDir out_dir) const;
    ...
    std::shared_ptr<TmMeshTopology> topology_ = nullptr;
    p_tm_mesh_link_t east_link_ = nullptr;
    p_tm_mesh_link_t west_link_ = nullptr;
